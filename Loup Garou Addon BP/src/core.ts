import { system, world, GameMode, EntityComponentTypes, Player } from "@minecraft/server";
...
export function startStopGameTimeout(message: string, forceStop?: boolean): void {
...
export function openResultForm(player: Player): void {
  const game = DB.game;
